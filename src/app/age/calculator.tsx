        ...
        <div style={{background:'linear-gradient(135deg,#eff6ff,#eef2ff)',borderRadius:16,padding:20,border:'1px solid #bfdbfe',marginTop:8}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(250px,1fr))',gap:10}}>
              ...
              <a key="/bmi" href="/bmi" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Health metrics at your current age</span>
              </a>
              <a key="/tdee" href="/tdee" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                <span style={{fontSize:14,fontWeight:600,color:'#2563eb'}}>TDEE Calculator →</span>
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Calorie needs change with age</span>
              </a>
              <a key="/compound-interest" href="/compound-interest" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Starting early multiplies money</span>
              </a>
          </div>
        </div>
