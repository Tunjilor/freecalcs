        ...
        <div style={{ background: 'linear-gradient(135deg,#eff6ff,#eef2ff)', borderRadius: 16, padding: 20, border: '1px solid #bfdbfe', marginTop: 20 }}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(250px,1fr))',gap:10}}>
              ...
              <a key="/tdee" href="/tdee" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Daily calorie needs for your body</span>
              </a>
              <a key="/age" href="/age" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Track health milestones by age</span>
              </a>
              <a key="/percentage" href="/percentage" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Body fat and health metrics</span>
              </a>
          </div>
        </div>
