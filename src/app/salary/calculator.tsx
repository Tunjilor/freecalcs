...
function compute(mode:string,sal:any,hrly:any,hrs:any,ot:any,bonus:any,filing:string,state:string,k401:any,hsa:any,health:any,fsa:any,roth:any,other:any):Res{
  let base=0;
