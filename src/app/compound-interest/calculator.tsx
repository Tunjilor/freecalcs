        ...
        <div style={{background:'linear-gradient(135deg,#eff6ff,#eef2ff)',borderRadius:16,padding:20,border:'1px solid #bfdbfe',marginTop:8}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(250px,1fr))',gap:10}}>
              ...
              <a key="/salary" href="/salary" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Know your take-home pay to plan investments</span>
              </a>
              <a key="/tax" href="/tax" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>See how taxes affect your returns</span>
              </a>
              <a key="/loan" href="/loan" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Compare borrowing costs vs investment gains</span>
              </a>
              <a key="/mortgage" href="/mortgage" style={{textDecoration:'none',display:'block',padding:'14px 18px',background:'rgba(255,255,255,0.9)',borderRadius:14,border:'1px solid #e2e8f0'}}>
                ...
                <span style={{display:'block',fontSize:13,color:'#64748b',marginTop:2}}>Plan your largest financial commitment</span>
              </a>
          </div>
        </div>
