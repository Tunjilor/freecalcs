    ...
    <>
      ...
      <article style={{ background: '#fff', borderTop: '1px solid #e5e7eb' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px 80px' }}>
          ...
          <RelatedTools heading="Keep reading" tools={[{href:'/blog/fha-vs-conventional-which-is-cheaper',label:'FHA vs conventional: which is actually cheaper?'},{href:'/blog/can-i-buy-a-house-with-640-credit-score',label:'Can I buy a house with a 640 credit score?'},{href:'/blog/28-36-rule-mortgage',label:'The 28/36 rule explained'},{href:'/blog/fha-loan-requirements',label:'FHA loan requirements 2026'},{href:'/blog/va-loan-eligibility',label:'VA loan eligibility 2026'}]} />
